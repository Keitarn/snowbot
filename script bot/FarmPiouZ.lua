...
FORBIDDEN_MONSTERS = {463,1247,2341,2342,2343,2344,2345,2347} --Fouduglen Leprechan & Archis--
FORCE_MONSTERS = {}

function move()

	inventory:useItem(16829,10)
	...
	return {
		...
		{map = "6,-19", path = "bottom|left"}, --Portal Incarnam--
		...
		{map = "3,-16", path = "bottom|right", gather = false, fight = true},
		{map = "4,-16", path = "bottom|left|right", gather = false, fight = true},
		{map = "5,-16", path = "bottom|top|right|", gather = false, fight = true},
		...
		{map = "4,-15", path = "left|right", gather = false, fight = true},
