...
function move()
	if (job:level(26) < 20) then
		...
		return {
			...
			{map = "5,-13", changeMap = "top", gather = true},
			{map = "5,-14", changeMap = "top", gather = true},
			{map = "5,-15", changeMap = "right", gather = true},
			{map = "6,-15", changeMap = "bottom"},
			{map = "6,-14", changeMap = "bottom", gather = true},
			{map = "6,-13", changeMap = "bottom", gather = true},
			{map = "6,-12", changeMap = "bottom", gather = true},
			{map = "6,-11", changeMap = "bottom", gather = true},
			{map = "6,-10", changeMap = "right", gather = true},
			{map = "7,-10", changeMap = "right", gather = true},
			...
			{map = "7,-16", changeMap = "left", gather = true},
			{map = "6,-16", changeMap = "left", gather = true},
			{map = "5,-16", changeMap = "top"},
			{map = "5,-17", changeMap = "right", gather = true},
			...
			{map = "5,-20", changeMap = "left", gather = true},
			...
			{map = "1,-22", changeMap = "top", gather = true},
			{map = "1,-23", changeMap = "right", gather = true},
			...
			{map = "0,-27", changeMap = "left", gather = true},
			{map = "-1,-27", changeMap = "left", gather = true},
			...
			{map = "-2,-21", changeMap = "left", gather = true},
	...
	elseif (job:level(26) >= 40) and (job:level(26) < 80) then
		...
		ELEMENTS_TO_GATHER = {67,66} --Trefles menthe
	...
	elseif (job:level(26) >= 80) and (job:level(26) < 100) then
		...
		return {
			...
			{map = "-18,4", changeMap = "right", gather = true},
	...
	elseif (job:level(26) >= 100) and (job:level(26) < 120) then
		...
		ELEMENTS_TO_GATHER = {61} --Edelweiss
		return {
	...
	elseif (job:level(26) >= 120) and (job:level(26) < 160) then
		--global:printMessage("Pandouille")
		ELEMENTS_TO_GATHER = {112} --Pandouille
		return {
	...
	elseif (job:level(26) >= 160) and (job:level(26) < 180) then
		...
		return {
			...
			{map = "-49,19", changeMap = "bottom"},
			{map = "-49,20", changeMap = "bottom", gather = true},
			{map = "-49,21", changeMap = "left"},
			{map = "-50,21", changeMap = "left", gather = true},
			{map = "-51,21", changeMap = "top"},
			{map = "-51,20", changeMap = "left"},
			{map = "-52,20", changeMap = "left"},
			{map = "-53,20", changeMap = "bottom", gather = true},
			{map = "-53,21", changeMap = "left"},
			{map = "-54,21", changeMap = "left", gather = true},
			{map = "-55,21", changeMap = "top", gather = true},
			{map = "-55,20", changeMap = "right"},
			{map = "-54,20", changeMap = "top", gather = true},
			{map = "-54,19", changeMap = "right", gather = true},
			{map = "-53,19", changeMap = "right"},
			{map = "-52,19", changeMap = "top", gather = true},
			{map = "-52,18", changeMap = "left"},
			{map = "-53,18", changeMap = "left", gather = true},
			{map = "-54,18", changeMap = "left"},
			{map = "-55,18", changeMap = "bottom"},
			{map = "-55,19", changeMap = "left"},
			{map = "-56,19", changeMap = "top", gather = true},
			{map = "-56,18", changeMap = "top", gather = true},
			{map = "-56,17", changeMap = "right", gather = true},
			...
			{map = "-53,15", changeMap = "right"},
			{map = "-52,15", changeMap = "top"},
			{map = "-52,14", changeMap = "right"},
	...
	elseif (job:level(26) >= 180) and (job:level(26) <= 200) then
		...
		return {
			...
			{map = "16,15", changeMap = "right", gather = true},
		}
	end
end
